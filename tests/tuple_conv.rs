...
fn tuple_conversions_cover_arities_one_through_six() {
    ...
    assert_ok_eq(<(u8, i8, u16)>::try_conv((7u16, -7i16, 9u32)), (7u8, -7i8, 9u16));
    assert_ok_eq(
...
fn tuple_conversions_cover_mixed_types_and_errors() {
    ...
    assert_range(<(u8, i8, u16, i16)>::try_conv((1u16, -1i16, 2u32, 40_000i32)));
    assert_range(<(u8, i8, u16, i16, u32)>::try_conv((1u16, -1i16, 2u32, -2i32, u64::MAX)));
    assert_range(
